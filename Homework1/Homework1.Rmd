...
library(png)
#Germany
img<-readPNG("Homework1/GeT.png")
mark<-ge
coun="Germany"
op<-par(ps=15)
plot(dat.scr[["ptime"]][mark], dat.scr[["dis"]][mark],ylim=c(0,400),xlim=c(0,125),xlab="Time (minutes)", ylab="Length of goal",main=coun)
lim <- par()
