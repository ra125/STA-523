...
#Netherlands
img<-readPNG("NeT.png")
>>>>>>> 8170730c87b777d22797f83b557ae8bc93c7b0e1
mark<-ne
coun="Netherlands"
op<-par(ps=15)
plot(dat.scr[["ptime"]][mark], dat.scr[["dis"]][mark],ylim=c(0,400),xlim=c(0,125),xlab="Time (minutes)", ylab="Length of goal (pixel)",main=coun)
