...
for(i in 1:nrow(dat.scr)) { 
  ...
  if(is.null(players[[player]])) { 
    players[[player]] <- list()
    players[[player]][["ID"]] <- toString(dat.scr[i, "pid"]);
    players[[player]][["Goals"]] <- list()
  }
  
  goal <- list(Type=toString(dat.scr[i, "ptype"]), MatchID=toString(dat.scr[i, "mid"]), Time=as.numeric(toString(dat.scr[i, "ptime"])), ExtraTime=as.numeric(toString(dat.scr[i, "paddtime"])), PIG_right=as.numeric(toString(dat.scr[i, "pig_right"])), Right=as.numeric(toString(dat.scr[i, "right"])), Top=as.numeric(toString(dat.scr[i, "top"]))) 
