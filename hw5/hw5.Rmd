...
s=c("100", 
    ...
    "10000000")
iteration=rep(s,6)
table1=data.frame("distribution_names"=unlist(reject_data[,1]),"N_iteration"=iteration,
                time_per_iteration)
```
```{r table2,results='asis'}
options(warn=-1)
x1=xtable(table1, type="html", digits=6)
options(warn=0)
...
tt2<-droplevels(reject_data_T[24,4])
tt2<-as.numeric(levels(tt2))

time_per_iteration2=c(as.numeric(levels(reject_data_T[,4])), tt2)

table2=data.frame("distribution_names"=unlist(reject_data_T[,1]),"N_iteration"=iteration,
                time_per_iteration)

```
```{r table3,results='asis'}
options(warn=-1)
x2=xtable(table2, type="html", digits=6)
options(warn=0)
