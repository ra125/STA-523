...
# data1=data2=data3=data4=data5=as.data.frame(matrix(0, nrow=1000, ncol=6))


################ Round 1: Utah (West Coast)
...
data.UT=cbind("uid"=uid, "state"=state, "address"=address, "phone"=phone, "lat"=lat, "long"=long)
...
data.DC=cbind("uid"=uid, "state"=state, "address"=address, "phone"=phone, "lat"=lat, "long"=long)
...
data.AL=cbind("uid"=uid, "state"=state, "address"=address, "phone"=phone, "lat"=lat, "long"=long)
...
data.HI=cbind("uid"=uid, "state"=state, "address"=address, "phone"=phone, "lat"=lat, "long"=long)
...
data.KS=cbind("uid"=uid, "state"=state, "address"=address, "phone"=phone, "lat"=lat, "long"=long)
