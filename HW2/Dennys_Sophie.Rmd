...
---
This is my attempt..will fix the "parseJSON error" later.
When I run the code, I was able to download the first page of the json file. And then due to the parsing error, I wasn't able to run the loop.
...
check_packages(c("httr","XML","sp","stringr","jsonlite","rgeos","maptools", "rgdal","ggplot2","spatsta","utils","jsonlite","stringr"))



### download the map file 
## or you can mannually download the file from the following url, & save it in your working directory.
temp<-tempfile()
...
state.center=coordinates(gCentroid(us, byid=TRUE))
...
states.abbr=as.vector(mainland$STATE_ABBR)
states.name=as.vector(mainland$STATE_NAME)


states.name=str_trim(states.name, side = "both")
states.name[27]<-"DC"
states.name
