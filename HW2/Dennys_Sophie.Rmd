...
check_packages(c("httr","XML","stringr","jsonlite","rgeos","maptools", "rgdal","ggplot2","spatsta","utils"))
# library(maptools)
...
## or you can mannually download the file at the following url, save it in your wd.
temp<-tempfile()
...
state.center=coordinates(gCentroid(mainland, byid=TRUE))
...
states=as.data.frame(mainland$STATE_ABBR)
