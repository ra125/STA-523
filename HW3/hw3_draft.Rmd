...
# Get rid of the observations that are not associated with Manhattan precincts [Think whether to do or not!!!!! Professor says we shouldnt do this, we assume all pluto data is for Manhattan]
...
namemap<-rbind(c("east","west","street","avenue","av","avee","road","drive","terrace","bway"), c("e","w","st","ave","ave","ave","rd","dr","ter","brdway"))
lnm<-ncol(namemap)
