...
#We assume that date can be wrong but rest of the data is correct so no need to filter in date

#Extract the necessary variables
address = filter(park, Violation.Precinct <= 34) %>%
