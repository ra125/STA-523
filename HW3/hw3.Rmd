...
q_lon<-matrix(quantile(z1$x, probs=c(0.01, 0.99), na.rm=TRUE))
q_lat<-matrix(quantile(z1$y, probs=c(0.01, 0.99), na.rm=TRUE))
...
q_lon<-matrix(quantile(z2$x, probs=c(0.01, 0.99), na.rm=TRUE))
q_lat<-matrix(quantile(z2$y, probs=c(0.01, 0.99), na.rm=TRUE))
...
z_true=z[sampled,]
z_true<-rbind(z_true,z22,z22,z22,z22)
z_true=z_true[,2:4]
