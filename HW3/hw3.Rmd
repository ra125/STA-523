...
check_packages(c("data.table","rgeos","ggmap","rgdal","maptools", "dplyr","stringr","lubridate","e1071"))
...
z<-z[pres,]
n=nrow(z)
sampled<-sample(1:n,as.integer(n*0.02), replace=FALSE)
z_true=z[sampled,]
